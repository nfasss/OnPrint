    ...
    <div class="container">
        ...
        <div class="container_L">
            <form class="myForm" action="insertUser_mysql.php" method="post">
                ...
                <input type="text" name="UserEmail" placeholder="Ali@gmail.com"><br>
                <label for="name">Phone Number:</label>
                <input type="text" name="UserPhoneNum" placeholder="012-3456789"><br>
                ...
                <br>
                <br>
                <input type="button" class="btn1" value="Clear" style="padding: 10px 50px;" onclick=" location.href='register.php'">
